  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <section className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900">Create your DevConnect account</h1>
        <p className="mt-2 text-sm text-slate-600">Share your stack, posts, and profile with other developers.</p>
